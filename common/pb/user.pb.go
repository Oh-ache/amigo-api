...
func (x *LoginAdminReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *LoginAdminReq) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
type AdminLoginSuccessResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AdminId       uint64                 `protobuf:"varint,1,opt,name=admin_id,json=adminId,proto3" json:"admin_id,omitempty"`
	Mobile        string                 `protobuf:"bytes,2,opt,name=mobile,proto3" json:"mobile,omitempty"`
	Username      string                 `protobuf:"bytes,3,opt,name=username,proto3" json:"username,omitempty"`
...
func (x *AdminLoginSuccessResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *AdminLoginSuccessResp) GetMobile() string {
	if x != nil {
		return x.Mobile
	}
	return ""
...
func (x *AdminLoginSuccessResp) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *AdminLoginSuccessResp) GetAvatar() string {
	if x != nil {
		return x.Avatar
	}
	return ""
...
func (x *AdminLoginSuccessResp) GetAccessToken() string {
	if x != nil {
...
func (x *AdminLoginSuccessResp) GetRefreshToken() string {
	if x != nil {
...
func (x *AdminLoginSuccessResp) GetExpiresIn() int64 {
	if x != nil {
		return x.ExpiresIn
	}
	return 0
...
const file_user_proto_rawDesc = "" +
	...
	"\n" +
	"expires_in\x18\a \x01(\x03R\texpiresIn\"6\n" +
	...
	"\n" +
	"expires_in\x18\x03 \x01(\x03R\texpiresIn\"U\n" +
	...
	"\x06errmsg\x18\x05 \x01(\tR\x06errmsg2\xf8\v\n" +
	"\x04User\x123\n" +
	...
	"\n" +
	"LoginAdmin\x12\x13.user.LoginAdminReq\x1a\x1b.user.AdminLoginSuccessResp\x12B\n" +
	"\x11RefreshAdminToken\x12\x15.user.RefreshTokenReq\x1a\x16.user.RefreshTokenResp\x12=\n" +
...
var file_user_proto_goTypes = []any{
	...
	(*RefreshTokenReq)(nil),         // 22: user.RefreshTokenReq
	(*RefreshTokenResp)(nil),        // 23: user.RefreshTokenResp
	(*BaseRoleItem)(nil),            // 24: user.BaseRoleItem
	(*BasePolicyItem)(nil),          // 25: user.BasePolicyItem
	(*GetAllDomainReq)(nil),         // 26: user.GetAllDomainReq
	(*GetAllDomainResp)(nil),        // 27: user.GetAllDomainResp
	(*GetRoleListeResp)(nil),        // 28: user.GetRoleListeResp
	(*GetPolicyListResp)(nil),       // 29: user.GetPolicyListResp
	(*CheckAdminPermissionReq)(nil), // 30: user.CheckAdminPermissionReq
	(*MiniappCodeReq)(nil),          // 31: user.MiniappCodeReq
	(*MiniappCodeResp)(nil),         // 32: user.MiniappCodeResp
}
var file_user_proto_depIdxs = []int32{
	2,  // 0: user.ListUserResp.list:type_name -> user.UserResp
	13, // 1: user.ListAdminResp.list:type_name -> user.AdminResp
	24, // 2: user.GetRoleListeResp.list:type_name -> user.BaseRoleItem
	25, // 3: user.GetPolicyListResp.list:type_name -> user.BasePolicyItem
	...
	22, // 17: user.User.RefreshAdminToken:input_type -> user.RefreshTokenReq
	26, // 18: user.User.GetAllDomain:input_type -> user.GetAllDomainReq
	24, // 19: user.User.GetRole:input_type -> user.BaseRoleItem
	24, // 20: user.User.GetRoleList:input_type -> user.BaseRoleItem
	24, // 21: user.User.AddRole:input_type -> user.BaseRoleItem
	24, // 22: user.User.DeleteRole:input_type -> user.BaseRoleItem
	25, // 23: user.User.GetPolicy:input_type -> user.BasePolicyItem
	25, // 24: user.User.GetPolicyList:input_type -> user.BasePolicyItem
	25, // 25: user.User.AddPolicy:input_type -> user.BasePolicyItem
	25, // 26: user.User.DeletePolicy:input_type -> user.BasePolicyItem
	30, // 27: user.User.CheckAdminPermission:input_type -> user.CheckAdminPermissionReq
	24, // 28: user.User.LoadUserPolicy:input_type -> user.BaseRoleItem
	24, // 29: user.User.LoadRolePolicy:input_type -> user.BaseRoleItem
	31, // 30: user.User.MiniappCode:input_type -> user.MiniappCodeReq
	10, // 31: user.User.AddUser:output_type -> user.LoginSuccessResp
	0,  // 32: user.User.DeleteUser:output_type -> user.SuccessResp
	0,  // 33: user.User.UpdateUser:output_type -> user.SuccessResp
	2,  // 34: user.User.GetUser:output_type -> user.UserResp
	8,  // 35: user.User.ListUser:output_type -> user.ListUserResp
	10, // 36: user.User.UserThirdLogin:output_type -> user.LoginSuccessResp
	10, // 37: user.User.Login:output_type -> user.LoginSuccessResp
	0,  // 38: user.User.AddAdmin:output_type -> user.SuccessResp
	0,  // 39: user.User.UpdateAdmin:output_type -> user.SuccessResp
	13, // 40: user.User.GetAdmin:output_type -> user.AdminResp
	19, // 41: user.User.ListAdmin:output_type -> user.ListAdminResp
	0,  // 42: user.User.DeleteAdmin:output_type -> user.SuccessResp
	21, // 43: user.User.LoginAdmin:output_type -> user.AdminLoginSuccessResp
	23, // 44: user.User.RefreshAdminToken:output_type -> user.RefreshTokenResp
	27, // 45: user.User.GetAllDomain:output_type -> user.GetAllDomainResp
	0,  // 46: user.User.GetRole:output_type -> user.SuccessResp
	28, // 47: user.User.GetRoleList:output_type -> user.GetRoleListeResp
	0,  // 48: user.User.AddRole:output_type -> user.SuccessResp
	0,  // 49: user.User.DeleteRole:output_type -> user.SuccessResp
	0,  // 50: user.User.GetPolicy:output_type -> user.SuccessResp
	29, // 51: user.User.GetPolicyList:output_type -> user.GetPolicyListResp
	0,  // 52: user.User.AddPolicy:output_type -> user.SuccessResp
	0,  // 53: user.User.DeletePolicy:output_type -> user.SuccessResp
	0,  // 54: user.User.CheckAdminPermission:output_type -> user.SuccessResp
	0,  // 55: user.User.LoadUserPolicy:output_type -> user.SuccessResp
	0,  // 56: user.User.LoadRolePolicy:output_type -> user.SuccessResp
	32, // 57: user.User.MiniappCode:output_type -> user.MiniappCodeResp
