...
type GaodeData struct {
	...
	Lives    []GaodeLive        `json:"lives"`
	Forecasts []GaodeForecast   `json:"forecasts"`
}

type GaodeLive struct {
...
type GaodeForecast struct {
	City       string             `json:"city"`
	Adcode     string             `json:"adcode"`
	Province   string             `json:"province"`
	Reporttime string             `json:"reporttime"`
	Casts      []GaodeForecastCast `json:"casts"`
}

type GaodeForecastCast struct {
